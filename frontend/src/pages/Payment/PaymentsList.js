...
const userPayments = payments.filter((r) => r.reservationID.userID === currUserID);
  ...
  {userPayments?.map((payment, index) => {
    ...
    return (
      ...
      >
        ...
        <td className="px-3 py-2">{new Date(reservationDate).toLocaleDateString("en-GB")}</td>
        <td className="px-3 py-2">{new Date(paymentDate).toLocaleDateString("en-GB")}</td>        
