  ...
  <div className="m-8 text-gray-300">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-800 p-6 rounded-lg shadow-lg">
      ...
      <div className="space-y-4">
        <p>
          <span className="font-semibold text-indigo-300">Complaint User:</span>
          <span className="ml-2 text-gray-300">{complaint.userID?.name}</span>
        </p>

        <p>
          <span className="font-semibold text-indigo-300">Email:</span>
          <span className="ml-2 text-gray-300">{complaint.userID?.email}</span>
        </p>

        <p>
          <span className="font-semibold text-indigo-300">Category:</span>
          <span className="ml-2 text-gray-300">{complaint.category}</span>
        </p>
      </div>
      ...
      <div className="space-y-4">
        <p>
          ...
          <span className="ml-2 text-gray-300">{complaint.status}</span>
        </p>

        <p>
          <span className="font-semibold text-indigo-300">Date Filed:</span>
      ...
      <p>
          <span className="font-semibold text-indigo-300">Complaint Text:</span>
          <span className="ml-2 text-gray-300">{complaint.complaintText}</span>
        </p>
